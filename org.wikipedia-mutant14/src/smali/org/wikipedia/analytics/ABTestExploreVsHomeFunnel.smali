.class public final Lorg/wikipedia/analytics/ABTestExploreVsHomeFunnel;
.super Lorg/wikipedia/analytics/ABTestFunnel;
.source "ABTestExploreVsHomeFunnel.java"
...
.method private log(Z)V
    ...
    const-string p1, "exploreVsHome_GroupA"

    goto :goto_0

    :cond_0
    const-string p1, "exploreVsHome_GroupB"
...
.method public shouldSeeHome()Z
    ...
    .line 12
    invoke-direct {p0, v1}, Lorg/wikipedia/analytics/ABTestExploreVsHomeFunnel;->log(Z)V
